    ...
    <section className="py-32">
      <div className="container mx-auto lg:px-0">
        ...
        <div className='flex flex-col lg:flex-row items-center '>
          <div className='flex-1 text-center lg:text-left  justify-center items-center  mb-10 '>
            <h2 className="font-primary font-semibold text-4xl mb-4">Visit our Kitchen</h2>
