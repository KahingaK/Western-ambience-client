      ...
      <div className="container mx-auto">
        <div className=" my-8">
          <div className="text-center">
            ...
            <p className="font-secondary text-md pb-4 px-4"> Uplift your business with our exceptional Conferencing facilities, guaranteeing smooth and productive gatherings. Cultivate team unity and enhance morale with our Team Building programs.</p>
          </div>
